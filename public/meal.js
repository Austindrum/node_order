var target = document.getElementById("date").value.split("-");
var Cal = function(divId) {
    ...
    this.currMonth = parseInt(target[1]) - 1;
    this.currYear = parseInt(target[0]);
    this.currDay = parseInt(target[2]);
  ...
  Cal.prototype.showMonth = function(y, m) {
    ...
    do {
      ...
      if (this.chkY == this.currYear && this.chkM == this.currMonth && i == this.currDay) {
            ...
            html += '<td class="normal"><a href="/meals/' + this.currYear + '-' + paramMonth + '-' + paramDate +'">' + i + '</a></td>';
      }
